...
function CommonForm({ fromControls, formData, setformData, onSubmit, buttonText }) {
  function renderInputsByComponentType(getControlItem) {
    ...
    switch (getControlItem.type) {
      case "input":
        return (
          <Input
            className="flex h-9 bg-transparent text-black shadow-sm transition-colors w-full border border-gray-300 p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      case "textarea":
        return (
          <Textarea
            className="flex min-h-[60px] bg-transparent text-black shadow-sm transition-colors w-full border border-gray-300 p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            placeholder={getControlItem.placeholder}
            name={getControlItem.name}
            value={value}
            onChange={(event) =>
  ...
  return (
    <form onSubmit={onSubmit} className="w-full space-y-4 h-full">
